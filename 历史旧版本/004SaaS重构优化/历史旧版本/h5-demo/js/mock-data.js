...
window.MockData = {
  ...
  // ===== 推广位列表 =====
  promotions: [
    { id: 'PROMO_001', name: '默认推广位', isDefault: true, activityCount: 6, createTime: '2025-06-15 10:00' },
    { id: 'PROMO_002', name: '新店开业推广', isDefault: false, activityCount: 4, createTime: '2026-01-20 14:30' },
    { id: 'PROMO_003', name: '会员日特惠', isDefault: false, activityCount: 3, createTime: '2026-02-14 09:00' },
    { id: 'PROMO_004', name: '新品上市', isDefault: false, activityCount: 5, createTime: '2026-03-01 16:00' },
    { id: 'PROMO_005', name: '夏日冰饮节', isDefault: false, activityCount: 6, createTime: '2026-05-01 11:00' }
  ],
  ...
  // ===== 可选活动池（活动选择器用） =====
  availableActivities: [
    { id: 'ACT001', name: '新店开业·全场8折', subtitle: '全场咖啡饮品8折优惠', image: '', commission: '8%', jumpType: 'password', jumpTypeLabel: '📋 需口令', platform: 'eleme', platformLabel: '饿了么', miniPath: '', h5Path: 'https://tbk.sunnycoffee.com/h5/act001?from=eleme', password: 'KouLing888', category: '促销活动', supplier: 'eleme', supplierLabel: '饿了么联盟', endDate: '2026-06-30' },
    { id: 'ACT002', name: '会员日·买一赠一', subtitle: '每周三会员专享', image: '', commission: '6%', jumpType: 'miniprogram', jumpTypeLabel: '📱 小程序路径', platform: 'meituan', platformLabel: '美团', miniPath: 'pages/member/index', h5Path: 'https://tbk.sunnycoffee.com/h5/member-day', password: '', category: '会员活动', supplier: 'meituan', supplierLabel: '美团联盟', endDate: '2026-07-15' },
    { id: 'ACT003', name: '夏日冰饮·第二杯半价', subtitle: '冰饮系列清凉一夏', image: '', commission: '5%', jumpType: 'password', jumpTypeLabel: '📋 需口令', platform: 'eleme', platformLabel: '饿了么', miniPath: '', h5Path: 'https://tbk.sunnycoffee.com/h5/summer-ice', password: 'SummerIce666', category: '促销活动', supplier: 'eleme', supplierLabel: '饿了么联盟', endDate: '2026-08-31' },
    { id: 'ACT004', name: '咖啡豆·限时特惠', subtitle: '精选阿拉比卡咖啡豆', image: '', commission: '10%', jumpType: 'miniprogram', jumpTypeLabel: '📱 小程序路径', platform: 'meituan', platformLabel: '美团', miniPath: 'pages/goods/detail?id=456', h5Path: 'https://tbk.sunnycoffee.com/h5/coffee-bean-sale', password: '', category: '商品活动', supplier: 'meituan', supplierLabel: '美团联盟', endDate: '2026-06-15' },
    { id: 'ACT005', name: '新品·抹茶拿铁上市', subtitle: '日式抹茶遇见醇香咖啡', image: '', commission: '7%', jumpType: 'miniprogram', jumpTypeLabel: '📱 小程序路径', platform: 'jd', platformLabel: '京东', miniPath: 'pages/new/product', h5Path: 'https://tbk.sunnycoffee.com/h5/matcha-latte', password: '', category: '新品活动', supplier: 'eleme', supplierLabel: '饿了么联盟', endDate: '2026-07-01' },
    { id: 'ACT006', name: '储值卡·充200送30', subtitle: '储值更优惠，多充多送', image: '', commission: '3%', jumpType: 'password', jumpTypeLabel: '📋 需口令', platform: 'meituan', platformLabel: '美团', miniPath: '', h5Path: 'https://tbk.sunnycoffee.com/h5/recharge-card', password: 'VIP2024CZ', category: '会员活动', supplier: 'meituan', supplierLabel: '美团联盟', endDate: '2026-09-30' },
    { id: 'ACT007', name: '外卖免配送费', subtitle: '订单满29元免配送费', image: '', commission: '4%', jumpType: 'miniprogram', jumpTypeLabel: '📱 小程序路径', platform: 'eleme', platformLabel: '饿了么', miniPath: 'pages/order/free', h5Path: 'https://tbk.sunnycoffee.com/h5/free-delivery', password: '', category: '配送活动', supplier: 'meituan', supplierLabel: '美团联盟', endDate: '2026-06-30' },
    { id: 'ACT008', name: '积分享好礼', subtitle: '消费积分兑换精美礼品', image: '', commission: '2%', jumpType: 'password', jumpTypeLabel: '📋 需口令', platform: 'meituan', platformLabel: '美团', miniPath: '', h5Path: 'https://tbk.sunnycoffee.com/h5/points-gift', password: 'PointsGift88', category: '会员活动', supplier: 'eleme', supplierLabel: '饿了么联盟', endDate: '2026-12-31' },
    { id: 'ACT009', name: '周末早鸟特惠', subtitle: '周末早晨7-9点专属折扣', image: '', commission: '6%', jumpType: 'miniprogram', jumpTypeLabel: '📱 小程序路径', platform: 'jd', platformLabel: '京东', miniPath: 'pages/weekend/earlybird', h5Path: 'https://tbk.sunnycoffee.com/h5/weekend-earlybird', password: '', category: '促销活动', supplier: 'meituan', supplierLabel: '美团联盟', endDate: '2026-07-31' },
    { id: 'ACT010', name: '联名款·限定杯', subtitle: '艺术家联名限定款杯套', image: '', commission: '8%', jumpType: 'missing', jumpTypeLabel: '⚠ 缺属性', platform: 'eleme', platformLabel: '饿了么', miniPath: '', h5Path: '', password: '', category: '品牌活动', supplier: 'eleme', supplierLabel: '饿了么联盟', endDate: '2026-08-15' },
    { id: 'ACT011', name: '毕业季·学生特惠', subtitle: '凭学生证享专属折扣', image: '', commission: '5%', jumpType: 'password', jumpTypeLabel: '📋 需口令', platform: 'meituan', platformLabel: '美团', miniPath: '', h5Path: 'https://tbk.sunnycoffee.com/h5/graduation-sale', password: 'Graduation2024', category: '促销活动', supplier: 'meituan', supplierLabel: '美团联盟', endDate: '2026-07-15' },
    { id: 'ACT012', name: '冰激凌咖啡·尝鲜价', subtitle: '阿芙佳朵系列全新上线', image: '', commission: '7%', jumpType: 'miniprogram', jumpTypeLabel: '📱 小程序路径', platform: 'jd', platformLabel: '京东', miniPath: 'pages/icecream/new', h5Path: 'https://tbk.sunnycoffee.com/h5/icecream-coffee', password: '', category: '新品活动', supplier: 'eleme', supplierLabel: '饿了么联盟', endDate: '2026-06-30' }
  ],
