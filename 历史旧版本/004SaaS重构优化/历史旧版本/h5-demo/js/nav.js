...
(function () {
  ...
  var menuConfig = [
    {
      id: 'c01', label: '取链及推广', icon: '📊',
      children: [
        { id: 'c01-a', label: '首页及取链', page: 'dashboard' },
        { id: 'c01-b', label: '推广位', page: 'promotion-list' },
        { id: 'c01-c', label: '效果报表', page: 'reports-list' }
      ]
    },
    {
      id: 'c02', label: '小程序管理', icon: '📱',
      children: [
        { id: 'c02-a', label: '小程序列表（有小程序）', page: 'miniprogram-list' },
        { id: 'c02-a2', label: '小程序列表（无小程序）', page: 'miniprogram-list-empty' },
        { id: 'c02-b', label: '权益页配置', page: 'benefit-config' }
      ]
    },
    {
      id: 'c03', label: '账号设置', icon: '👤',
      children: [
        { id: 'c03-a', label: '企业信息', page: 'account-info' },
        { id: 'c03-b', label: '修改密码', page: 'account-pwd' }
      ]
    },
    {
      id: 'c04', label: '登录模块', icon: '🔑',
      children: [
        { id: 'c04-a', label: 'PC端登录页', page: 'login' }
      ]
    }
  ];
  ...
  function loadPage(page) {
    ...
    xhr.open('GET', 'pages/' + pageFile, true);
    xhr.onload = function () {
